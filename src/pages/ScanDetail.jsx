...
export default function ScanDetail() {
  ...
  return (
    <div className="w-full p-4 md:p-6 bg-gray-100 dark:bg-[#0F0F0F] min-h-screen flex flex-col gap-6">

      {/* TOP BAR */}
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">

        {/* Breadcrumb */}
       <div className="flex items-center gap-3 text-[15px] ml-12 md:ml-0">
      ...
      {/* TOP CARD */}
      <div className="bg-[#F8FAFC] dark:bg-[#141414] rounded-2xl p-4 md:p-6 flex flex-col gap-6 border border-gray-200 dark:border-[#2A2A2A] w-full">
      ...
      {/* CONSOLE + FINDINGS */}
      <div className="bg-white dark:bg-[#141414] rounded-2xl border border-gray-200 dark:border-[#2A2A2A] overflow-hidden flex flex-col lg:flex-row lg:h-[520px] w-full">

        {/* Console */}
        <div className="w-full lg:w-2/3 border-b lg:border-b-0 lg:border-r border-gray-200 dark:border-[#2A2A2A]">
          <ConsolePanel />
        </div>

        {/* Findings */}
        <div className="w-full lg:w-1/3 bg-gray-50 dark:bg-[#1A1A1A]">
          <FindingLog />
        </div>
